...
public class SwipeHandler : Singleton<SwipeHandler>
{
    ...
    public static Vector3 GetSwipeDirection()
    {
        return new Vector3(CurrentSwipe.x, 0f, CurrentSwipe.y);
    }

    static Vector2 GetCurrentSwipe(Vector2 swipe) => CurrentSwipe = swipe;
